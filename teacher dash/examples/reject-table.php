...
<head>
  ...
  <title>Rejected Assesments</title>
  <!-- Favicon -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">REJECTED Asignments</h6>
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="card-header bg-transparent">
              <h3 class="mb-0">Rejected Assesments</h3>
...
<script>
          $(document).ready(function(){
            ...
            var interval;
            fetchverified();
            interval = setInterval(fetchverified,5000);
            ...
            $(document).on('click', '.start_chat', function(){
              ...
              function search(){
                  ...
                  $('#search_txt').keyup(function(){
                      ...
                      if(txt =""){
                        interval = setInterval(fetchverified,3000);
                      }
                      else{
